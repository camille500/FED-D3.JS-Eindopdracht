(function() {
  ...
  */
  ...
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.skipButtonTemplate = '<button class="btn btn-default btn-sm pull-right tour-next">Overslaan →</button>';

    Base.prototype.nextButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Volgende stap →</button>';

    Base.prototype.finalButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Sluit de tour</button>';
    ...
    */
    ...
    Base.prototype._buildContentElement = function(step) {
      ...
      content = $($.parseHTML(this.template({
        ...
        counter: step.final ? '' : "stap " + (step.index + 1) + " van " + step.total,
